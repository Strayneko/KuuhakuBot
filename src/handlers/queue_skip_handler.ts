...
import { skipTrack } from "@/services/queue_service";

/**
 * Handler for the skip command
 * Skips the current track
 * @param msg The Discord message object
 * @param cmdArg The command arguments (not used for skip)
 */
export default async function queueSkipHandler(msg: Message, cmdArg: string): Promise<void> {
